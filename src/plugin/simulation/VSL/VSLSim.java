...
public class VSLSim extends Simulation implements SimulationImpl{
    ...
    public VSLSim(String caseFile, int seed, Section section, VISSIMVersion v, VSLVersion _vv, SimInterval sInterval, SimObjects simObjects){
        super(caseFile,seed,section,v,sInterval, simObjects);
