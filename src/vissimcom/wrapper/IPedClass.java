 ...
 *
 * Dispatch: IPedClass
 * Description: Interface to access and modify pedestrian classes.
 * Help file:   
 *
 * @author JawinTypeBrowser
 */

public class IPedClass extends DispatchPtr {
	public static final GUID DIID = new GUID("{7d491de5-04bd-41db-945D-88D726267FBC}");
	public static final int IID_TOKEN;
	static {
		IID_TOKEN = IdentityManager.registerProxy(DIID, IPedClass.class);
	}
	 ...
	 * IPedClass (it is required by Jawin for some internal working though).
	 */
	public IPedClass() {
		super();
	}
	 ...
	 * the IPedClass interface.
	 * 
	 * @param progid the progid of the COM-object to create.
	 */
	public IPedClass(String progid) throws COMException {
		super(progid, DIID);
	}
	 ...
	 */
	public IPedClass(GUID clsid) throws COMException {
		super(clsid, DIID);
	}

	/**
	 * For getting the IPedClass interface on an existing COM-object.
	 * This is an alternative to calling {@link #queryInterface(Class)}
	 * on comObject.
	 * 
	 * @param comObject the COM-object to get the IPedClass interface on.
	 */
	public IPedClass(COMPtr comObject) throws COMException {
		super(comObject);
	}
