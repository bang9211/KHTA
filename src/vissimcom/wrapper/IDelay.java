 ...
 *
 * Dispatch: IDelay
 * Description: Interface to access and modify delays.
 * Help file:   
 *
 * @author JawinTypeBrowser
 */

public class IDelay extends DispatchPtr {
	public static final GUID DIID = new GUID("{dc6ce0b7-264a-41ef-9972-844C447E266F}");
	public static final int IID_TOKEN;
	static {
		IID_TOKEN = IdentityManager.registerProxy(DIID, IDelay.class);
	}
	 ...
	 * IDelay (it is required by Jawin for some internal working though).
	 */
	public IDelay() {
		super();
	}
	 ...
	 * the IDelay interface.
	 * 
	 * @param progid the progid of the COM-object to create.
	 */
	public IDelay(String progid) throws COMException {
		super(progid, DIID);
	}
	 ...
	 */
	public IDelay(GUID clsid) throws COMException {
		super(clsid, DIID);
	}

	/**
	 * For getting the IDelay interface on an existing COM-object.
	 * This is an alternative to calling {@link #queryInterface(Class)}
	 * on comObject.
	 * 
	 * @param comObject the COM-object to get the IDelay interface on.
	 */
	public IDelay(COMPtr comObject) throws COMException {
		super(comObject);
	}
