 ...
 *
 * Dispatch: ITransitLine
 * Description: Interface to access and modify a transit lines.
 * Help file:   
 *
 * @author JawinTypeBrowser
 */

public class ITransitLine extends DispatchPtr {
	public static final GUID DIID = new GUID("{10db93c0-260b-4b53-849E-919495B5DFAE}");
	public static final int IID_TOKEN;
	static {
		IID_TOKEN = IdentityManager.registerProxy(DIID, ITransitLine.class);
	}
	 ...
	 * ITransitLine (it is required by Jawin for some internal working though).
	 */
	public ITransitLine() {
		super();
	}
	 ...
	 * the ITransitLine interface.
	 * 
	 * @param progid the progid of the COM-object to create.
	 */
	public ITransitLine(String progid) throws COMException {
		super(progid, DIID);
	}
	 ...
	 */
	public ITransitLine(GUID clsid) throws COMException {
		super(clsid, DIID);
	}

	/**
	 * For getting the ITransitLine interface on an existing COM-object.
	 * This is an alternative to calling {@link #queryInterface(Class)}
	 * on comObject.
	 * 
	 * @param comObject the COM-object to get the ITransitLine interface on.
	 */
	public ITransitLine(COMPtr comObject) throws COMException {
		super(comObject);
	}
