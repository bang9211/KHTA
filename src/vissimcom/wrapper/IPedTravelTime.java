 ...
 *
 * Dispatch: IPedTravelTime
 * Description: Interface to access and modify pedestrian travel time measurements.
 * Help file:   
 *
 * @author JawinTypeBrowser
 */

public class IPedTravelTime extends DispatchPtr {
	public static final GUID DIID = new GUID("{93eaee57-37f6-44c9-AE81-B72D7FEDA814}");
	public static final int IID_TOKEN;
	static {
		IID_TOKEN = IdentityManager.registerProxy(DIID, IPedTravelTime.class);
	}
	 ...
	 * IPedTravelTime (it is required by Jawin for some internal working though).
	 */
	public IPedTravelTime() {
		super();
	}

	/**
	 * For creating a new COM-object with the given progid and with 
	 * the IPedTravelTime interface.
	 * 
	 * @param progid the progid of the COM-object to create.
	 */
	public IPedTravelTime(String progid) throws COMException {
		super(progid, DIID);
	}
	 ...
	 */
	public IPedTravelTime(GUID clsid) throws COMException {
		super(clsid, DIID);
	}

	/**
	 * For getting the IPedTravelTime interface on an existing COM-object.
	 * This is an alternative to calling {@link #queryInterface(Class)}
	 * on comObject.
	 * 
	 * @param comObject the COM-object to get the IPedTravelTime interface on.
	 */
	public IPedTravelTime(COMPtr comObject) throws COMException {
		super(comObject);
	}
