...
public class IPedArea extends DispatchPtr {
	public static final GUID DIID = new GUID("{fc8794bd-024b-42f8-963E-5105FBA449F6}");
	public static final int IID_TOKEN;
	static {
		IID_TOKEN = IdentityManager.registerProxy(DIID, IPedArea.class);
	}
	 ...
	 * IPedArea (it is required by Jawin for some internal working though).
	 */
	public IPedArea() {
		super();
	}
	 ...
	 * the IPedArea interface.
	 * 
	 * @param progid the progid of the COM-object to create.
	 */
	public IPedArea(String progid) throws COMException {
		super(progid, DIID);
	}
	 ...
	 */
	public IPedArea(GUID clsid) throws COMException {
		super(clsid, DIID);
	}

	/**
	 * For getting the IPedArea interface on an existing COM-object.
	 * This is an alternative to calling {@link #queryInterface(Class)}
	 * on comObject.
	 * 
	 * @param comObject the COM-object to get the IPedArea interface on.
	 */
	public IPedArea(COMPtr comObject) throws COMException {
		super(comObject);
	}
