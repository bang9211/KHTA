 ...
 *
 * Dispatch: IDetector
 * Description: Interface to access and modify detectors.
 * Help file:   
 *
 * @author JawinTypeBrowser
 */

public class IDetector extends DispatchPtr {
	public static final GUID DIID = new GUID("{f512fd12-a7ad-4635-A335-AC727BD0091A}");
	public static final int IID_TOKEN;
	static {
		IID_TOKEN = IdentityManager.registerProxy(DIID, IDetector.class);
	}
	 ...
	 * IDetector (it is required by Jawin for some internal working though).
	 */
	public IDetector() {
		super();
	}
	 ...
	 */
	public IDetector(String progid) throws COMException {
		super(progid, DIID);
	}
	 ...
	 */
	public IDetector(GUID clsid) throws COMException {
		super(clsid, DIID);
	}

	/**
	 * For getting the IDetector interface on an existing COM-object.
	 * This is an alternative to calling {@link #queryInterface(Class)}
	 * on comObject.
	 * 
	 * @param comObject the COM-object to get the IDetector interface on.
	 */
	public IDetector(COMPtr comObject) throws COMException {
		super(comObject);
	}
