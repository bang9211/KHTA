 ...
 *
 * Dispatch: IDataCollection
 * Description: Interface to access and modify data collections.
 * Help file:   
 *
 * @author JawinTypeBrowser
 */

public class IDataCollection extends DispatchPtr {
	public static final GUID DIID = new GUID("{859b5c7b-c2e8-49dd-9F47-B0255136F3CC}");
	public static final int IID_TOKEN;
	static {
		IID_TOKEN = IdentityManager.registerProxy(DIID, IDataCollection.class);
	}
	 ...
	 * IDataCollection (it is required by Jawin for some internal working though).
	 */
	 ...
	 */
	public IDataCollection(String progid) throws COMException {
		super(progid, DIID);
	}
	 ...
	 */
	public IDataCollection(GUID clsid) throws COMException {
		super(clsid, DIID);
	}

	/**
	 * For getting the IDataCollection interface on an existing COM-object.
	 * This is an alternative to calling {@link #queryInterface(Class)}
	 * on comObject.
	 * 
	 * @param comObject the COM-object to get the IDataCollection interface on.
	 */
	public IDataCollection(COMPtr comObject) throws COMException {
		super(comObject);
	}
