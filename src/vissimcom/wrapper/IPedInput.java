 ...
 *
 * Dispatch: IPedInput
 * Description: Interface to access and modify pedestrian inputs.
 * Help file:   
 *
 * @author JawinTypeBrowser
 */

public class IPedInput extends DispatchPtr {
	public static final GUID DIID = new GUID("{e49a94cb-c825-4bff-8C1B-334A1B120D09}");
	public static final int IID_TOKEN;
	static {
		IID_TOKEN = IdentityManager.registerProxy(DIID, IPedInput.class);
	}
	 ...
	 * IPedInput (it is required by Jawin for some internal working though).
	 */
	public IPedInput() {
		super();
	}
	 ...
	 * the IPedInput interface.
	 * 
	 * @param progid the progid of the COM-object to create.
	 */
	public IPedInput(String progid) throws COMException {
		super(progid, DIID);
	}
	 ...
	 */
	public IPedInput(GUID clsid) throws COMException {
		super(clsid, DIID);
	}

	/**
	 * For getting the IPedInput interface on an existing COM-object.
	 * This is an alternative to calling {@link #queryInterface(Class)}
	 * on comObject.
	 * 
	 * @param comObject the COM-object to get the IPedInput interface on.
	 */
	public IPedInput(COMPtr comObject) throws COMException {
		super(comObject);
	}
