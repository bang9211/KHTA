 ...
 *
 * Dispatch: IRoutingDecision
 * Description: IRoutingDecision interface.
 * Help file:   
 *
 * @author JawinTypeBrowser
 */

public class IRoutingDecision extends DispatchPtr {
	public static final GUID DIID = new GUID("{37d931a7-da58-423e-80C1-A296B4ED4D0F}");
	public static final int IID_TOKEN;
	static {
		IID_TOKEN = IdentityManager.registerProxy(DIID, IRoutingDecision.class);
	}
	 ...
	 * IRoutingDecision (it is required by Jawin for some internal working though).
	 */
	public IRoutingDecision() {
		super();
	}

	/**
	 * For creating a new COM-object with the given progid and with 
	 * the IRoutingDecision interface.
	 * 
	 * @param progid the progid of the COM-object to create.
	 */
	public IRoutingDecision(String progid) throws COMException {
		super(progid, DIID);
	}
	 ...
	 */
	public IRoutingDecision(GUID clsid) throws COMException {
		super(clsid, DIID);
	}

	/**
	 * For getting the IRoutingDecision interface on an existing COM-object.
	 * This is an alternative to calling {@link #queryInterface(Class)}
	 * on comObject.
	 * 
	 * @param comObject the COM-object to get the IRoutingDecision interface on.
	 */
	public IRoutingDecision(COMPtr comObject) throws COMException {
		super(comObject);
	}
    ...
    * @return void
    **/
    public IRoutes getRoutes() throws COMException
    {
        IRoutes res = new IRoutes();
          DispatchPtr dispPtr = (DispatchPtr)get("Routes");
    ...
    * @return int
    **/
    public int AddTimeInterval(double From,double To) throws COMException
    {
      
		return ((Integer)invokeN("AddTimeInterval", new Object[] {new Double(From), new Double(To)})).intValue();
