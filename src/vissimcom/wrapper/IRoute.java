 ...
 *
 * Dispatch: IRoute
 * Description: IRoute interface.
 * Help file:   
 *
 * @author JawinTypeBrowser
 */

public class IRoute extends DispatchPtr {
	public static final GUID DIID = new GUID("{8d60481f-c5c9-4847-A352-C43F707DA32D}");
	public static final int IID_TOKEN;
	static {
		IID_TOKEN = IdentityManager.registerProxy(DIID, IRoute.class);
	}
	 ...
	 * IRoute (it is required by Jawin for some internal working though).
	 */
	public IRoute() {
		super();
	}
	 ...
	 */
	public IRoute(String progid) throws COMException {
		super(progid, DIID);
	}
	 ...
	 */
	public IRoute(GUID clsid) throws COMException {
		super(clsid, DIID);
	}

	/**
	 * For getting the IRoute interface on an existing COM-object.
	 * This is an alternative to calling {@link #queryInterface(Class)}
	 * on comObject.
	 * 
	 * @param comObject the COM-object to get the IRoute interface on.
	 */
	public IRoute(COMPtr comObject) throws COMException {
		super(comObject);
	}
