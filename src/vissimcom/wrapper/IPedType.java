 ...
 *
 * Dispatch: IPedType
 * Description: Interface to access and modify pedestrian types.
 * Help file:   
 *
 * @author JawinTypeBrowser
 */

public class IPedType extends DispatchPtr {
	public static final GUID DIID = new GUID("{bb93a0a6-bcab-4798-93B9-A67FF9ABFAE6}");
	public static final int IID_TOKEN;
	static {
		IID_TOKEN = IdentityManager.registerProxy(DIID, IPedType.class);
	}
	 ...
	 * IPedType (it is required by Jawin for some internal working though).
	 */
	public IPedType() {
		super();
	}
	 ...
	 * the IPedType interface.
	 * 
	 * @param progid the progid of the COM-object to create.
	 */
	public IPedType(String progid) throws COMException {
		super(progid, DIID);
	}
	 ...
	 */
	public IPedType(GUID clsid) throws COMException {
		super(clsid, DIID);
	}

	/**
	 * For getting the IPedType interface on an existing COM-object.
	 * This is an alternative to calling {@link #queryInterface(Class)}
	 * on comObject.
	 * 
	 * @param comObject the COM-object to get the IPedType interface on.
	 */
	public IPedType(COMPtr comObject) throws COMException {
		super(comObject);
	}
