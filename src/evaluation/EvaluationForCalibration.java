...
//                Evaluation();
//            }
//            if (selectedOption.getEvaluationOption().hasOption(OptionType.OUT_CSV)) {
//                CumSimStations = new ArrayList<CStation>();
//                EvaluationCSV();
//                
//            }
...
//             */
//            if(selectedOption.getEvaluationOption().hasOption(OptionType.OUT_CONTOUR)){
...
//        if(selectedSimulationResult.IsListData()){
//            //SimObject
//            SimulationSeveralResult ssr = new SimulationSeveralResult(SectionD,option.getPeriods()[0]);
...
//        }
//        
//        System.out.println("Reading Datas(Period : " + option.getPeriods()[0].getPeriodString() + ")");
//        //simulation
...
//        
//        DataCol.add(AddTimeArray(Col++,new String[]{String.valueOf(this.StationStateSims.size()),String.valueOf(this.StationStateSims.get(0).size()),""},option.getPeriods()[0].getTimeline()));
//        
//        //Evaluate of each Station
//        if(this.StationStateSims.size() > 0){
//            for(int i=0;i<StationStateSims.get(0).size();i++){
//                String RNodeLabel = SectionH.getStationStates().get(i).getRNode().getLabel()+"("+SectionH.getStationStates().get(i).getRNode().getStationId()+")";
...
//        
//        //Add Time Info
//        AddTimes(sheet,Col++,new String[]{String.valueOf(this.StationStateSims.size()),String.valueOf(this.StationStateSims.get(0).size()),""},option.getPeriods()[0].getTimeline());
//        
//        //Evaluate of each Station
//        if(this.StationStateSims.size() > 0){
//            for(int i=0;i<StationStateSims.get(0).size();i++){
